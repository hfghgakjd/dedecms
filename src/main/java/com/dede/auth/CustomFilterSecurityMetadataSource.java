package com.dede.auth;

import com.dede.Utils.ConvertUtils;
...
public class CustomFilterSecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
    ...
    private List<ConfigAttribute> getMatcherConfigAttribute(String requestUrl) {
    	List<Role> list = roleService.findRoleTypeByUrl(requestUrl);
	    List<ConfigAttribute> resultList = list.stream()
    ...
    private List<String> allowedRequest() {
        return Arrays.asList("/loginPage", "/css/**", "/fonts/**", "/js/**", "/scss/**", "/img/**","/resources/**");
    }
